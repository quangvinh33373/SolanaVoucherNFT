...
export default function DrawerNavigation({navigation}) {
  ...
  return (
        ...
        <Drawer.Screen name="Hóa Đơn" component={QuanLyPhong}
        options={{
            drawerLabel: "Voucher",
            title: "Voucher",
            drawerIcon: () => (
              <Foundation name="dollar-bill" size={25} color="black" style={{margin:3}} />
            )
          }}
         />
          <Drawer.Screen name="Thông tin cá nhân" component={NhanVienScreen}
        options={{
         ...
         />
         {chucVu === 'Quản lý' ? (
          <Drawer.Screen name="Khách Hàng" component={NhanVienScreen}
            options={{
